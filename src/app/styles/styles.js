...
const styles = {
    ...
    dropdownBtn: "flex items-center gap-2 bg-indigo-800 text-stone-50 px-4 py-2 rounded-md text-sm shadow-md hover:shadow-lg transition-all duration-300 ease-in-out hover:scale-105 focus:outline-none",
    dropdownMenu: "absolute mt-2 right-0 w-56 bg-indigo-300 border border-indigo-700 rounded-md shadow-2xl z-50 backdrop-blur-xl animate-fade-in-down transition-all duration-300 ease-in-out",
    dropdownItem: "w-full text-left px-4 py-2 text-sm text-neutral-800 font-medium hover:bg-indigo-800 hover:text-stone-50 rounded-md transition-colors duration-200",

    primaryBtn: "bg-indigo-800 text-stone-50 px-6 py-2 rounded-md text-sm shadow hover:bg-indigo-900 transition",
    secondaryBtn: "border border-indigo-800 text-neutral-900 px-6 py-2 rounded-md text-sm hover:bg-indigo-200 hover:scale-105 transition transform",

    heroTitle: "text-1xl md:text-5xl font-bold bg-gradient-to-r from-indigo-800 to-indigo-900 bg-clip-text text-transparent mb-6",
    ...
    toggleActive: "text-indigo-800",
    toggleInactive: "text-gray-500 hover:text-indigo-500",
    ...
    modalClose: "absolute top-2 right-3 text-2xl font-bold text-neutral-900 hover:text-indigo-500 cursor-pointer",

    vrImg: "rounded-xl shadow-lg overflow-hidden w-full h-64 bg-gray-200 flex items-center justify-center",
    box: "flex items-center gap-4 bg-gray-50 rounded-2xl shadow-md px-6 py-5 border border-gray-200 w-80 transition-transform duration-300 ease-in-out transform hover:bg-indigo-200 hover:scale-105 hover:shadow-lg hover:-translate-y-1 cursor-pointer",
    ...
    footer: "bg-indigo-900 text-stone-100 py-8 mt-20",
    ...
    loadingDiv: "w-20 h-20 border-t-4 border-b-4 border-indigo-600 rounded-full animate-spin",
