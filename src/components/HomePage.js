        ...
        <>
            ...
            <div className={`${styles.container} relative z-10`}>
                    ...
                    <div className="max-w-2xl w-full">
                        ...
                        <div className="flex flex-wrap justify-center gap-4">
                            <button
                                ...
                                className={`${styles.primaryBtn} bg-indigo-600 hover:bg-indigo-700`}
                            >
                            ...
                            <button
                                ...
                                className={`${styles.secondaryBtn} border-indigo-500 text-indigo-600 hover:bg-indigo-50`}
                            >
                                ▶ Watch Demo
                            </button>
                        </div>
                ...
                {showLoginModal && (
                    <div className={styles.modalOverlay}>
                        <div className={styles.modalBox}>
                            <button onClick={() => setShowLoginModal(false)} className={styles.modalClose}>
                                ×
                            </button>
                ...
                {showRegisterModal && (
                    <div className={styles.modalOverlay}>
                        <div className={styles.modalBox}>
                            <button onClick={() => setShowRegisterModal(false)} className={styles.modalClose}>
                                ×
                            </button>
